package com.bigpicture.team.ev.adapter;
...
import com.bigpicture.team.ev.Constant;
import com.bigpicture.team.ev.R;
...
public class MapListAdapter extends RecyclerView.Adapter<MapListAdapter.ViewHolder> {
    ...
    private ArrayList<ESCInfoItem> itemList;
     ...
     */
    public MapListAdapter(Context context, int resource, ArrayList<ESCInfoItem> itemList) {
     ...
     */
    public void setItemList(ArrayList<ESCInfoItem> itemList) {
        this.itemList = itemList;
    ...
    public void onBindViewHolder(ViewHolder holder, int position) {
        final ESCInfoItem item = itemList.get(position);
