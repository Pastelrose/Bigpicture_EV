...
import com.bigpicture.team.ev.adapter.MapListAdapter;
import com.bigpicture.team.ev.item.ESCInfoItem;
import com.bigpicture.team.ev.item.GeoItem;
 ...
 */
public class ESCMapFragment extends Fragment
    ...
    private HashMap<Marker, ESCInfoItem> markerMap = new HashMap<>();

    RecyclerView list;
    MapListAdapter adapter;
    ArrayList<ESCInfoItem> infoList = new ArrayList<>();
    ...
    private void listMap(int memberSeq, LatLng latLng, int distance, LatLng userLatLng) {
        ...
        call.enqueue(new Callback<ArrayList<ESCInfoItem>>() {
            @Override
            public void onResponse(Call<ArrayList<ESCInfoItem>> call,
                                   Response<ArrayList<ESCInfoItem>> response) {
                ArrayList<ESCInfoItem> list = response.body();
            ...
            @Override
            public void onFailure(Call<ArrayList<ESCInfoItem>> call, Throwable t) {
            }
        });
    }
     ...
     * @param list 맛집 리스트
     */
    private void setMap(ArrayList<ESCInfoItem> list) {
     ...
     * @param list 맛집 리스트
     */
    private void addMarker(ArrayList<ESCInfoItem> list) {
